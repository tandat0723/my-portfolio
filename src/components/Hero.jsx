...
const Hero = () => {
    return (
        <section className='relative'>
            <div className='max-w-7xl mx-auto'>
                <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between'>
                    <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
                        <h1 className='lg:text-7xl text-4xl font-bold lg:leading-snug'>Xin chào!
                    ...
                    <div className='md:w-1/2 relative flex justify-center items-end'>
                        <img src={profile_img} alt='' className='lg:w-[90vh] w-100' />
            ...
            <div className='absolute top-70 right-10 hidden bg-gray-200 p-4 md:flex flex-col gap-6 rounded-full'>
