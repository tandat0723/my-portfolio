...
const Navbar = () => {
    ...
    return (
        <header className='sticky top-0 z-50 w-full border-b border-gray-100 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 px-4 lg:px-0'>
